...
<p align="center">
  <a href="https://umutseve4.github.io/sectio-turbofan/"><b>Canlı demo</b></a>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/CI%20kontrol%C3%BC-29-FF4D4F?style=flat-square" alt="29 CI kontrolü">
</p>
...
En hızlısı: [canlı demo](https://umutseve4.github.io/sectio-turbofan/).
...
Üçüncü adım yok. Uygulama kodu hiçbir harici kaynağa başvurmaz: CDN yok, font yok, analitik yok, `fetch`/XHR/WebSocket yok.
...
Tarayıcı açılamayan bir ortamda geliştirildiği için doğrulanabilir olan her şey `verify.mjs` ile CI'da koşar: **29 kontrol**.
...
Bu 29 sayısı elle yazılmadı: CI her koşuda gerçekten çalışan kontrolleri sayar ve README ile karşılaştırır, uyuşmazsa iş kırmızı olur.
...
**Doğrulamanın kapsamadığı.** Yukarıdaki 29 kontrol shader'ın gerçek bir GPU'da derlendiğini, kare hızını, seçim (pick) geçişini ve 3B etiket yerleşimini ölçmez. Bunlar ancak dosyayı açınca test edilir; yukarıdaki ekran görüntüsü o testin yapıldığını gösteriyor.
